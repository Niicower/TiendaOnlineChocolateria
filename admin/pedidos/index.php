...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este pedido de forma permanente?","delete_order",[$(this).attr('data-id')])
		})
		$('.pay_order').click(function(){
			_conf("¿Estás seguro de marcar este pedido como pagado??","pay_order",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
