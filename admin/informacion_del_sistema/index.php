	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
	            ...
	            <textarea name="about_us" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app.'Nosotros.html') ? file_get_contents(base_app.'Nosotros.html') : "" ?></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="" class="control-label">imagenes Banner</label>
				<div class="custom-file">
				...
				<small><i>Cargar nuevas imagenes banner</i></small>
			</div>
			<?php 
...
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    console.log(resp)
                    alert_toast("Ocurrio un error al eliminar la imagen","error");
                }
                end_loader()
            }
        })
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("¿Desea eliminar la imagen permanentemente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
