	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <option value="" selected="" disabled="">Seleccionar categoría primero</option>
                <?php
...
<script>
	...
	$(document).ready(function(){
        $('.rem_img').click(function(){
            _conf("¿Está seguro de eliminar la imagen permanentemente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
        ...
        $('#categorias_id').change(function(){
            ...
            $('#sub_categoria_id').select2({placeholder:"Seleccione aquí",width:"relative"})
        })
