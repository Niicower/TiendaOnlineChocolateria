...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Agregar nueva Categoria","maintenance/manage_brand.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar detalles de la Categoria","maintenance/manage_brand.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
