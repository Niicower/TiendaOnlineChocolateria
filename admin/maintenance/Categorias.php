...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Listado ode Categorias</h3>
...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Añadir nueva categoria","maintenance/manage_category.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar detalles de la categoría","maintenance/manage_category.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
