...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=packages/manage" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create Nuevo</a>
		</div>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `packages` order by date(fecha_de_creacion) desc ");
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este paquete de forma permanente?","delete_package",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
