...
(function (global, factory) {
  ...
  /**
   * Mostrar a console warning, but only if it hasn't already been shown
   * @param message
   */
  ...
  /**
   * Mostrar a one-time console warning about deprecated params/methods
   */
  ...
  /**
   * Mostrar relevant warnings for given params
   *
   * @param params
   */
