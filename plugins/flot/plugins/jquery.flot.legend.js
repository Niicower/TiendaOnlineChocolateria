...
(function($) {
    ...
    function insertLegend(plot, options, placeholder, legendEntries) {
        ...
        // Save the legend Entradas in legend options
        var Entradas = options.legend.legendEntries = legendEntries,
        ...
        // Generate html for icons and labels from a list of Entradas
        for (i = 0; i < Entradas.length; ++i) {
            let columnIndex = i % options.legend.noColumns;
            entry = Entradas[i];
            iconHtml = '';
        ...
        var legendEl,
            height = Math.ceil(Entradas.length / options.legend.noColumns) * 1.6;
    ...
    // Generate a list of legend Entradas in their final order
    ...
    // Compare two lists of legend Entradas
