...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        /*
         * Mostrar some element in range defined by user
        ...
        onUpdateEvent: function (e, opt) {
            ...
            if (opt.mapOptions && (
                ...
                // Mostrar all elements on the map before updating the legends
                $("[data-type='legend-elem']", self.$container).each(function (id, elem) {
                    if ($(elem).attr('data-hidden') === "1") {
                        $(elem).trigger("click", {hideOtherElems: false, animDuration: animDuration});
                    }
            ...
            // Hide/Mostrar all elements based on showlegendElems
